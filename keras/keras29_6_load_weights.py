...
# model.save_weights(path + 'keras29_5_save_ave_weights1.h5')
# model.load_weights(path + 'keras29_5_save_ave_weights1.h5') #에러
# -> 가중치면 저장 됨. 사용하려면 모델이 정의가 되어야 한다
...
# -> 가중치면 저장 됨. 사용하려면 모델이 정의가 되어야 한다. 컴파일까지 명시가 되어야 함.
