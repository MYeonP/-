...
y3 = np.array(range(201, 301)) #(100, )      # 아모레의 하루 뒤 종가 예측
...
# 2-4. 모델 병합
from tensorflow.keras.layers import concatenate, Concatenate     # concatenate : 사슬처럼 엮다 / 붙였다, 연결했다
...
# 2-6. 모델 7 분기3.
dense7 = Dense(33, activation='linear', name='ds61')(last_output)
dense7 = Dense(32, activation='linear', name='ds62')(dense7)
dense7 = Dense(32, activation='linear', name='ds63')(dense7)
dense7 = Dense(32, activation='linear', name='ds64')(dense7)
output7 = Dense(33, activation='linear', name='ds65')(dense7)
...
model.fit([x1_train, x2_train, x3_train], [y1_train, y2_train], epochs=300, batch_size=32)
...
loss :  [675.3483276367188, 9.524641990661621, 665.8236694335938]
